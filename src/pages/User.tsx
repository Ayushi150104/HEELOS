...
import { cardsData, tasks } from "../assets/Data";
        ...
        >
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-left text-sm md:text-base">
              ...
              <tbody>
                {tasks.map(({ id, priority, status, name, endBy }) => {
                  ...
                  return (
                    <tr
                      key={id}
                      className="border-b border-gray-700 hover:bg-[#393e6c] transition-colors cursor-pointer"
                    >
